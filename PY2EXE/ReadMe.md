...
<h1><p align="center">Создание запускного файла<br>из Пайтон-скрипта с включением всех ресурсов,<br>используемых в Python приложении (графика, звук, шрифты и т.п.)</p><h1>
...
&nbsp;&nbsp;&nbsp;&nbsp;Чтобы обойти эту проблему необходимо выполнить добавление файлов сборки ВРУЧНУЮ в файл спецификации сборки name.spec
...
Каждый файл идет в виде кортежа (tuple) с двумя элементами: 1) относительный (от папки скрипта) путь к файлу и его название и
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;Там же идёт речь, что полный абсолютный путь к папке распаковки сохраняется pyinstaller-ом в системной переменной sys._MEIPASS.<br>
